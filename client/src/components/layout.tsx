...
import { LayoutDashboard, Users, Send, Settings, Search } from "lucide-react";
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: "/", label: "Ricerca Lead", icon: Search },
        ...
        <div className="p-4 mt-auto border-t border-gray-100">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-500 truncate">API Key attive</p>
            </div>
          </div>
        </div>
      </aside>
